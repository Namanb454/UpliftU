        ...
        autofill:pb-2" placeholder="This is a textarea placeholder" defaultValue={""} />
          ...
          peer-[:not(:placeholder-shown)]:text-neutral-400">Tell us about your project</label>
                                ...
                                <div className="mt-2">
                                    ...
                                    <p className="mt-5">
                                        <a className="group inline-flex items-center gap-x-2 py-2 px-3 bg-indigo-500 font-medium text-sm text-white rounded-full focus:outline-none" href="#">
                                            Submit
                        ...
                        <div className="space-y-14">
                            ...
                            <div className="flex gap-x-5">
                                ...
                                <div className="grow">
                                    ...
                                    <p className="mt-2">
                                        <a className="group inline-flex items-center gap-x-2 font-medium text-sm text-indigo-500 decoration-2 hover:underline focus:outline-none focus:underline" href="#">
                                            Job openings
                                            <svg className="shrink-0 size-4 transition group-hover:translate-x-0.5 group-hover:translate-x-0 group-focus:translate-x-0.5 group-focus:translate-x-0" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg>
                                        </a>
                                    </p>
