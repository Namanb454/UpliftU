    ...
    return (
        <ParallaxProvider>
            <div className='w-full'>
                ...
                <div className="z-10 relative text-center w-full rounded-3xl mx-auto bg-cover"
                    style={{
                        backgroundImage: `url('/Website_Images/26-a-light-subtle-pathway-or-timeline-graphic-as-a-background-include-markers-or-waypoints-that-symbo.jpeg')`,
                    }}
                >
                    <div className='backdrop-blur-sm text-center w-full border-2 border-black rounded-3xl px4 py-10 sm:px- lg:px-0 lg:py-12 mx-auto'>
                        {/* Grid */}
