                            ...
                            <div class="xl:grid grid-cols-2 mt-12 text-center gap-x-6 gap-y-12 lg:mt-16 lg:grid-cols-4 lg:gap-x-8 lg:gap-y-16">
                                {whyUpliftU.map((data, index) => {
                                    return (
                                        ...
                                        <div className='rounded-3xl border-2 p-[1vw] border-[#1f2740] bg-[#1f2740] lg:h-[40vh] h-[30vh] w-[100%] xl:my-0 my-[5vh]'>
                                            <div class="mt-6 w-[80%] mx-auto items-center">
                                                {/* <h3 class="font-medium text-gray-900">Live editing</h3> */}
                                                <p class="mt-2 xl:text-[1.3vw] text-[#bae2e4]  font-normal text-justify items-center">
                                                    {data.desc}
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div className="grid mt-12 gap-y- gap-x-2 md:grid-cols-2">
                                <div>
                                    ...
                                    <div className="mt-2 xl:rounded-tl-full border-2 border-[#1f2740] bg-[#1f2740] h-[30vh] flex items-center justify-center my-auto">
                                        <p className=" font-light xl:text-[1.5vw] text-[5vw] xl:p-[5vw] text-[#bae2e4]">Engagement Through content</p>
                                ...
                                <div>
                                    ...
                                    <div className="mt-2 xl:rounded-tr-full border-2 border-[#1f2740] bg-[#1f2740] h-[30vh] flex items-center justify-center my-auto">
                                        <p className=" font-light xl:text-[1.5vw] text-[5vw] xl:p-[5vw] text-[#bae2e4]">Make You Become The Influencer</p>
                                    </div>
                                </div>
                                <div>
                                    <div className="mt-2 xl:rounded-bl-full border-2 border-[#1f2740] bg-[#1f2740] h-[30vh] flex items-center justify-center my-auto">
                                        <p className=" font-light xl:text-[1.5vw] text-[5vw] xl:p-[5vw] text-[#bae2e4]">Boosting Hospitality Through Social Media Content</p>
                                    </div>
                                ...
                                <div>
                                    <div className="mt-2 xl:rounded-br-full border-2 border-[#1f2740] bg-[#1f2740] h-[30vh] flex items-center justify-center my-auto">
                                        <p className=" font-light xl:text-[1.5vw] text-[5vw] xl:p-[5vw] text-[#bae2e4]">Build Community that Resonates with Brand</p>
                                    </div>
                ...
                <section>
                    {services.map((data, index) => {
                        return (
                            ...
                            <div className=" items-center w-full py-12 mx-auto  lg:py-24 px-[10vw]  text-justify">
                                ...
                                ${index === 3 && 'flex-row-reverse'}
                                    ...
                                    <div className="md:order-first space-y-[5vh] xl:text-[1vw] xl:w-[80%]">
                                        ...
                                        <p className='xl:text-[1.3vw]'>{data.tagline}</p>
                                    ...
                                    <div className="order-first block mt-12 aspect-square lg:mt-0 xl:w-1/2">
